...
| STAFF-SS-02-05 | C1 / B1 | Every profile opens with one emphasised status header — name, position, group, availability, restrictions, bio figures, development plan — the coach's without body mass. | **Step 1 inventory answered 2026-09-13** (`docs/overnight-records-2026-09-12.md`, SS-02-05): the only per-role difference in the header is the coach's missing Weight cell, already true (C9); no setting is needed (Q27). `--blue-100/200` → `--wash-accent` / `--border-accent-soft`. | **Build next** · medium |
