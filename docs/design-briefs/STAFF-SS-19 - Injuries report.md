# Design brief — STAFF-SS-19, Injuries report
...
1. **One report, two contents.** The medic sees clinical columns the sport
   scientist does not. A proposal designs both renderings, and the boundary is
   not a layout choice (`CLINICAL_ONLY`).
2. **The period options are the most explanatory of the six** — the pattern
   at its best; keep it.
