# Design brief — STAFF-COACH-33, Print a screen
...
screen is identical to the sport scientist's by measurement, the SS-33 brief is
...
1. **Identical to STAFF-SS-33** — `PrintButton` on the same three screens for the coach; the print block hides the shell and every form.
