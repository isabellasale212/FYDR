# Design brief — STAFF-SC-05, Athlete profile — gym and weigh-ins, no clinical detail, no bio edit
...
1. **The S&C's profile has no Availability panel and no SAR section** (absent, not locked) and the bio Edit and corrections are blocked with a reason on tap (`BlockedButton`); the Body-weight trio is live. A proposal keeps absence for what the role cannot see and a stated block for what it can see but not change.
2. **Clinical content stays in the Injury panel's medic body only.**
...
1. **The S&C's order** in the role-ordered panel library (SS-02-05 C4): S&C history log, Athleticism, Body weight, Injury (censored), Flags, Goals, Nutrition plan, Entries and corrections — the inventory gives the counts (8 panels).
2. **Sideways scroll at 375** on the profile for every role (§0ap's class; the roster table) — the SS-05 brief carries it.
