# Design brief — STAFF-COACH-30h, Thresholds
...
screen is identical to the sport scientist's by measurement, the SS-30 brief is
...
1. **Identical to STAFF-SS-30h by fingerprint**, both widths; the SS-30 brief is the design surface. `THRESHOLD_EDIT` is the coach's.
...
1. **The three "baseline" links at 13px** on the new-threshold form at 375 — in the sweep; nothing else coach-specific.
