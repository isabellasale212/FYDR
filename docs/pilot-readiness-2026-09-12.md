...
- ~~**§0al reopened 2026-09-13** — the offline publish still navigates to the browser's offline page (the humanised error misses the network guard); the held week survives.~~ **Closed, `b636b21`** — re-run offline by the reviewer: the tab stays, the message reads, the week is kept.
