...
**A header** with the period and the group filter.
...
|---|---|---|---|---|---|---|---|
| Group filter chips | Header | Narrows to a group | Stays here | Nothing. A cookie remembers it | Report access | None | Never |
