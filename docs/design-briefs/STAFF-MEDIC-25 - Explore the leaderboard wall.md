# Design brief — STAFF-MEDIC-25, Explore the leaderboard wall
...
**Read the STAFF-SHELL brief and the STAFF-SS-25 brief first.** The phone shell
...
1. **Identical to STAFF-SS-25**; on a board page the medic's one control is "Suppress an athlete" — a medical suppression that must stay indistinguishable from a self opt-out (0016). A proposal keeps it quiet and unexplained on the public side.
