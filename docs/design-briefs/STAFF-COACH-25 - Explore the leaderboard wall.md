# Design brief — STAFF-COACH-25, Explore the leaderboard wall
...
screen is identical to the sport scientist's by measurement, the SS-25 brief is
...
1. **Identical to STAFF-SS-25 by fingerprint**, both widths; the SS-25 brief is the design surface.
2. **The lens becomes a real tablist** (§0am) — build work, not design.
...
1. **Nothing coach-specific**; "Profile ›" at 19px is in the sweep.
