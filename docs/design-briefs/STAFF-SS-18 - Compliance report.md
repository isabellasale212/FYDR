# Design brief — STAFF-SS-18, Compliance report
...
1. **The screen does not say what "submitted" means** — §0ad: a late rating
   counts. Once decided, the report should state its own rule, the way it
   states its scope.
2. **It fits one desktop screen** — keep that; it is the report staff glance
   at most.
