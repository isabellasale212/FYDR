...
- [ ] **Rehab groups: restrictions were never left off deliberately — the board simply never drew them. Answered from history 2026-09-09.**
...
- [ ] **Team allocation: does it stay availability-only, or show the limited injury view like every other coach screen? NOT YET DECIDED, and deliberately not written into the spec as a rule.**
