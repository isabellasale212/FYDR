# Design brief — STAFF-MEDIC-24, Rehab programmes
...
1. **The detail link's label is the tell and stays one** — "Edit this programme →" on a rehab programme, "View full detail →" on a standard one, for the medic.
2. **`/programmes/new` is a rehab programme for the medic** (`PROGRAMME_AUTHOR`) and says so.
...
1. **Nothing medic-specific beyond the label**; the SS-24 brief is the design surface.
