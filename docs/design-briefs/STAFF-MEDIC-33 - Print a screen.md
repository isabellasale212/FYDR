# Design brief — STAFF-MEDIC-33, Print a screen
...
**Read the STAFF-SHELL brief and the STAFF-SS-33 brief first.** The phone shell
...
**Full review: `docs/walkthrough-reviews/staff-medic-16-to-33-review.md`.**
...
1. **Identical to STAFF-SS-33**; the print block hides the shell and every form.
2. **A printed injury board from the medic carries the problem-reports section** — athletes' own words — and today no confidentiality marking; the PDF route already banners the medic's injuries PDF "MEDICAL IN CONFIDENCE". A proposal gives the print stylesheet the same banner when the page holds medic-only content.
...
1. **The one design question this flow has**: the confidentiality banner on a medic's printout, and nothing else.
