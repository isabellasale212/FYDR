# Design brief — STAFF-MEDIC-02, Browse the squad
...
1. **Identical to STAFF-SS-02 minus "Add athlete"** — absent, not locked.
2. **The roster is the physio's touchline list**: name · position · status; it scrolls sideways at 375 today (§0ap, roster table).
...
1. **The touchline roster at 375**: who is out, who is modified, at a glance, without the sideways scroll.
