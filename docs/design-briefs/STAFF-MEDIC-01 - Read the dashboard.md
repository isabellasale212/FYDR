# Design brief — STAFF-MEDIC-01, Read the dashboard
...
1. **Identical to STAFF-SS-01 by measurement**; the SS-01 brief (and the STAFF-SS-01 board, C2 recorded) is the design surface. Flags is the medic's bar slot on a phone.
2. **Nothing clinical is on the dashboard** and nothing should be — the dashboard is read by every role.
