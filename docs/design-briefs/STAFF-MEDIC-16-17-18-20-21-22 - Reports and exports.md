# Design brief — STAFF-MEDIC-16-17-18-20-21-22, Reports and exports
...
**Read the STAFF-SHELL brief and the STAFF-SS-16 brief first.** The phone shell
...
1. **Identical to STAFF-SS-16 to -22 by fingerprint**, both widths; those briefs are the design surface. No export or PDF carries clinical content for any role, the medic included (verified 2026-09-12); a proposal keeps every report clinical-free.
2. **The medic's injuries PDF keeps its "MEDICAL IN CONFIDENCE" banner.**
...
1. **Nothing medic-specific**; the four sideways-scrolling reports at 375 are §0ax.
