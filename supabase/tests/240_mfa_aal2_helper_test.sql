...
--
-- migration 0049's public.auth_is_aal2() — login-security checklist item 3 (MFA). Written
...
--      own record of the "shipped but deliberately not wired in yet" state 0049 documents in
...
-- ===========================================================================
-- 3. Deliberately not wired into any policy yet — see migration 0049's own header.
-- ===========================================================================
...
select is(
  ...
  0,
  'auth_is_aal2() is not yet referenced by any RLS policy — migration 0049''s header '
