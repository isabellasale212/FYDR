  ...
  return (
    <>
          ...
          {planSummary ? (
            <p className="cap" style={{ marginTop: 10 }}>
              ...
              {planSummary.unmapped.length > 0
                ...
                : ''}{' '}
              Compliance expectations are not regenerated by this build — see the page footer.
            </p>
          ) : null}
        </div>
      ) : null}
      ...
      <p className="cap" style={{ marginTop: 14 }}>
        No undo in this build, and no conflict check if someone else changes this week while you
        have this page open — both real, documented gaps. See lib/queries/weekTemplates.ts for
        the rest of what this pass cuts against the full spec.
      </p>
    </>
  );
}
