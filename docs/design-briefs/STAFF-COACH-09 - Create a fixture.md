# Design brief — STAFF-COACH-09, Create a fixture
...
**Read the STAFF-SHELL brief and the STAFF-SS-09 brief first.** The phone shell
is built (`af09c17` + `6a2f1d4`); this flow is measured on it. The coach's screen
is identical to the sport scientist's by measurement — the SS-09 brief is the
...
1. **Identical to STAFF-SS-09 by measurement**, both widths, nothing under 44px at 375. The SS-09 brief is the design surface.
2. **The form's own note stays** — a fixture reaches every athlete and names nobody; it is the sentence a coach needs before "Create fixture".
...
1. **Nothing coach-specific.** If SS-09 is redesigned, the coach inherits it.
