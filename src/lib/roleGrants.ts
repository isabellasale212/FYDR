...
export const CAPABILITIES: readonly Capability[] = [
  ...
  { key: 'thresholds_read', label: 'Reading the thresholds, and the rule behind a flag', roles: THRESHOLD_VIEW },
  { key: 'thresholds', label: 'Editing thresholds', roles: THRESHOLD_EDIT },
